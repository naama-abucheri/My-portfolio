          ...
          <div className="space-y-8 animate-fade-in">
            <div>
              ...
              <p className="text-lg text-muted-foreground">
                Digital Marketer | WordPress Developer | Software Developer
              </p>
            </div>
          ...
          <div className="flex justify-center lg:justify-end animate-slide-up">
            <div className="relative">
              ...
              <img 
                ...
                alt="Naama Abucheri - Digital Marketing & Development Professional"
                className="relative w-80 h-80 lg:w-96 lg:h-96 object-cover rounded-full shadow-elegant border-4 border-background hover:scale-105 transition-transform duration-500"
              />
            </div>
          </div>
        </div>
